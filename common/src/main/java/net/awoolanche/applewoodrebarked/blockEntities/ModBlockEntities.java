...
public class ModBlockEntities {
        ...
        public static final RegistrySupplier<BlockEntityType<AppleBarrelBlockEntity>> APPLE_BARREL_ENTITY = registerBlockEntity("apple_barrel", () -> BlockEntityType.Builder.of(AppleBarrelBlockEntity::new, ModBlocks.APPLE_BARREL.get()).build(null));
